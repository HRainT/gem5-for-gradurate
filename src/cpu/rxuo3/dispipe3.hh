...
class Dispipe3
{
  public:
    ...
    typedef std::queue<DynInstPtr> orderQueue;
    enum Dispipe3Status
    {
        Active,
        Inactive
  ...
  private:
    ...
    void checkAndSplitEop(DynInstPtr& inst);
  ...
  public:
    ...
    bool intnomal_wtb_full =false;
    bool intspecial_wtb_full =false;
    bool fp_wtb_full =false;
    bool vector_wtb_full =false;
    bool ldst_vector_ready = true;

    std::map<uint64_t, std::vector <DynInstPtr>> vector_ldstQueue;
  ...
  public:
    ...
    /*for order vector ld/st such as vloxei*/
    std::map<uint64_t,orderQueue> ldstOrderMap;
  ...
  private:
    ...
    struct Dispipe3Stats : public statistics::Group
    {
        ...
        /** Stat for number of times the ibuffer24 becomes full. */
        statistics::Scalar ibuffer24FullEvents;
        /** Stat for number of times the ibuffer25 becomes full. */
        statistics::Scalar ibuffer25FullEvents;
        /** Stat for number of times the ibuffer26 becomes full. */
        statistics::Scalar ibuffer26FullEvents;
        /** Stat for number of times the ibuffer27 becomes full. */
        statistics::Scalar ibuffer27FullEvents;
        ...
        /** Stat for total number of instructions into ibuffer 24. */
        statistics::Scalar ibuffer24Insts;
        /** Stat for total number of instructions into ibuffer 25. */
        statistics::Scalar ibuffer25Insts;
        /** Stat for total number of instructions into ibuffer 26. */
        statistics::Scalar ibuffer26Insts;
        /** Stat for total number of instructions into ibuffer 27. */
        statistics::Scalar ibuffer27Insts;
        ...
        /** Stat for total number of instructions into ibuffer 12. */
        statistics::Scalar LD_full;
        /** Stat for total number of instructions into ibuffer 12. */
        statistics::Scalar ST_full;
    } stats;
};
