...
WTB::insert(DynInstPtr &new_inst)
{
    ...
    if(new_inst->isStore() && new_inst->unlocaldata){
        ...
        // if(new_inst->stdDataReady && new_inst->stdReady == false){
