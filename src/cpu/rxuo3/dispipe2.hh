...
private:
   ...
   // InstQueue stdb[2];
    ...
    struct Dispipe2Stats : public statistics::Group
    {
        ...
        /** Stat for number of times the disqueue24 becomes full. */
        statistics::Scalar disqueue24FullEvents;
        /** Stat for number of times the disqueue25 becomes full. */
        statistics::Scalar disqueue25FullEvents;
        /** Stat for number of times the disqueue26 becomes full. */
        statistics::Scalar disqueue26FullEvents;
        /** Stat for number of times the disqueue27 becomes full. */
        statistics::Scalar disqueue27FullEvents;
    } stats;
};
