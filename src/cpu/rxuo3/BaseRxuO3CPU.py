...
class BaseRxuO3CPU(BaseCPU):
    ...
    fetchWidth = Param.Unsigned(17, "Fetch width")
    ...
    IBWidth = Param.Unsigned(6, "InstBuffer width")
    ...
    predisqWidth = Param.Unsigned(6, "Predisq width")
    ...
    dispipe0Width = Param.Unsigned(6, "Dispipe0 width")
    ...
    dispipe1Width = Param.Unsigned(8, "Dispipe1 width")
    ...
    numIntSpecialEntries = Param.Unsigned(12, "Number of int special ibuffer entries")
    ...
    intNormalOddRegReadNums = Param.Unsigned(4, "Number of int normal odd regfile read ports")
    intSpecialOddRegReadNums = Param.Unsigned(2, "Number of int special odd regfile read ports")
    intNormalEvenRegReadNums = Param.Unsigned(4, "Number of int normal even regfile read ports")
    intSpecialEvenRegReadNums = Param.Unsigned(2, "Number of int special even regfile read ports")

    intNormalOddRegWriteNums = Param.Unsigned(2, "Number of int normal odd regfile write ports")
    intSpecialOddRegWriteNums = Param.Unsigned(1, "Number of int special odd regfile write ports")
    intNormalEvenRegWriteNums = Param.Unsigned(2, "Number of int normal even regfile write ports")
    intSpecialEvenRegWriteNums = Param.Unsigned(1, "Number of int special even regfile write ports")

    ldstOddRegReadNums = Param.Unsigned(2, "Number of load/store odd regfile read ports")
    ldstEvenRegReadNums = Param.Unsigned(2, "Number of load/store odd regfile read ports")
    fstRegReadNums = Param.Unsigned(2, "Number of fstore regfile read ports")

    fpNormalRegReadNums = Param.Unsigned(4, "Number of float normal regfile read ports")
    fpSpecialRegReadNums = Param.Unsigned(2, "Number of float special regfile read ports")

    fpRegWriteNums = Param.Unsigned(3, "Number of float regfile write ports")

    fldRegWriteNums = Param.Unsigned(1, "Number of float load regfile write ports")

    vectorReadRegNums = Param.Unsigned(7, "Number of float load regfile write ports")

    vectorLDSTReadRegNums = Param.Unsigned(2, "Number of float load regfile write ports")
    ...
    LQEntries = Param.Unsigned(204, "Number of load queue entries")
    ...
    numVecRobEntries = Param.Unsigned(256, "Number of vector reorder buffer entries")
    numPhysVecCsrRegs = Param.Unsigned(32, "Number of physical vector csr registers")
    ...
    branchPredTAGE = Param.BranchPredictor(
    ...
    shift = Param.Unsigned(2, "Number of bits to shift PC when calculating index.")
