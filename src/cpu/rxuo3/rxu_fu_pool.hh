#ifndef __CPU_RxuO3_FU_POOL_HH__
#define __CPU_RxuO3_FU_POOL_HH__
 ...
 * latencies.
 */
class RxuFUPool : public SimObject
{
  private:
  ...
  public:
    typedef RxuFUPoolParams Params;
    /** Constructs a FU pool. */
    RxuFUPool(const Params &p);
    ~RxuFUPool();
...
#endif // __CPU_RxuO3_FU_POOL_HH__
