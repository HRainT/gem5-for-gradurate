    ...
    struct VectorQueueStats : public statistics::Group
      {
          ...
          /** Stat for total number of cycles Vector stall. */
          statistics::Scalar VQStallCycles;
          /** Stat for total number of cycles spent squashing. */
          statistics::Scalar VQStallInsts;
          /** Stat for average cycles of Vector Queue stall as vset. */
          statistics::Formula VQAverageStall;
          statistics::Distribution circle_invectorQ;
          statistics::Scalar number_instIssue;
          statistics::Formula number_instIssueOneCircle;
          statistics::Scalar number_instMacroIn;
          statistics::Formula number_instMacroInOneCircle;
