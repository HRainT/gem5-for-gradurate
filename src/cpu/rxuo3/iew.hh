#ifndef __CPU_RxuO3_IEW_HH__
#define __CPU_RxuO3_IEW_HH__
...
class IEW
{
  ...
  public:
    ...
    IEW(CPU *_cpu, const BaseRxuO3CPUParams &params);
    ...
    void setDispipe2Queue(TimeBuffer<Dispipe2Struct> *rq_ptr);
  ...
  private:
    ...
    /** Removes instructions from dispipe2 from a thread's instruction list. */
    void emptyDispipe2Insts(ThreadID tid);
  ...
  private:
    ...
    /** Skid buffer between dispipe2 and IEW. */
  ...
  private:
    ...
    /** Dispipe2 to IEW delay. */
    Cycles dispipe2ToIEWDelay;
