...
class DynInst : public ExecContext, public RefCounted
{
  ...
  protected:
   ...
   public:
    ...
    /** uop list */
    std::list<DynInstPtr> MicroopQueue;
  ...
  public:
    ...
    bool ifstdissued = false;
    bool ifstdataready = false;
    bool ifstaready = false;
  ...
  public:
    ...
    bool needFRM() const {
        return (opClass() == 4 || opClass() == 8 || opClass() == 7 || opClass() == 9 || opClass() == 6 || opClass() == 11);
    }

    bool needVxrm() const {
        return (opClass() == 25 || opClass() == 28 || opClass() == 29 || opClass() == 31 || opClass() == 32 || opClass() == 34 || opClass() == 38);
    }
// test for eop
    ...
    bool isVIndexORStrideLoad() const {
        return (opClass() == 62 || opClass() == 64 || opClass() == 70);
    }
    bool isVIndexORStrideStore() const {
        return (opClass() == 63 || opClass() == 65);
    }
    bool isIndexLDST() const {
        return (opClass() == 64 || opClass() == 65 || opClass() == 62);
    }
    bool needEop() const {
        return (opClass() == 62 || opClass() == 63 || opClass() == 64 || opClass() == 65 || opClass() == 70);
    }
//end for eop
