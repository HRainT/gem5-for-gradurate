...
class WTB
{
  ...
  public:
    ...
    /** The number of float normal regfile free read ports. */
    unsigned vectorRegReadFreeNums;
    ...
    /** ibuffer. */
    std::list<DynInstPtr> ibuffer[MaxThreads][24];
