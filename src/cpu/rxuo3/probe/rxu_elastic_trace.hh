#ifndef __CPU_RxuO3_PROBE_ELASTIC_TRACE_HH__
#define __CPU_RxuO3_PROBE_ELASTIC_TRACE_HH__
...
#include "params/RxuElasticTrace.hh"
...
/**
 * The rxu_elastic trace is a type of probe listener and listens to probe points
 * in multiple stages of the RxuO3CPU. The notify method is called on a probe
 ...
 */
class RxuElasticTrace : public ProbeListenerObject
{
  ...
  public:
    ...
    /** Constructor */
    RxuElasticTrace(const RxuElasticTraceParams &params);
  ...
  private:
    ...
    /**
     * Whther the rxu_elastic trace listener has been registered for all probes.
     *
    ...
    /** Pointer to the RxuO3CPU that is this listener's parent a.k.a. manager */
    CPU *cpu;
    ...
    struct RxuElasticTraceStats : public statistics::Group
    {
        RxuElasticTraceStats(statistics::Group *parent);
...
#endif//__CPU_RxuO3_PROBE_ELASTIC_TRACE_HH__
