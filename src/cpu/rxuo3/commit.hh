...
class Commit
{
  ...
  public:
    ...
    //For specific PC predict miss rate stats 
    Addr SpecificPC;
  ...
  public:
    struct CommitStats : public statistics::Group
    {
        ...
        statistics::Scalar fetch_latency1;
        statistics::Scalar fetch_latency2;
        statistics::Scalar fetch_latency3andover;
        statistics::Scalar fetch_latencyfault;
        ...
        /** Number of odd dest reg int special instructions. */
        statistics::Scalar DestOddLoad;
        /** Number of even dest reg int special instructions. */
        statistics::Scalar DestEvenLoad;
        ...
        /** Number of odd dest reg fp normal instructions. */
        statistics::Scalar DestOddVector;
        /** Number of even dest reg fp normal instructions. */
        statistics::Scalar DestEvenVector;
        /** Number of odd src0 reg load/store instructions. */

        /** For vector statistics */
        statistics::Scalar vsetivliInstNum;
        statistics::Scalar vsetvliInstNum;
        statistics::Scalar vsetvlInstNum;
        statistics::Scalar vsetivliVlChangedNum;
        statistics::Scalar vsetvliVlChangedNum;
        statistics::Scalar vsetvlVlChangedNum;
