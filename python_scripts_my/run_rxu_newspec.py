...
# 配置部分
base_dir = "/Data3/xiaohan.zhang/workspace/SPECint2006_NEMU_G_Zicond_Zba_Zbb/473.astar"  # 根目录
output_base_dir = "/Data3/yutong.han/My_G5Project/graduate-for-gem5-vector/out/spec/0703_NoBranchNet_astar"  # 输出基础目录
