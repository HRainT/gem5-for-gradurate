...
if [ "$just_compare" != "0" ]; then
    ...
    for kernel in "${kernels[@]}"; do
        ...
        --outdir=./out/vec-compare-2/$kernel_base \
...
for kernel in "${kernels[@]}"; do
    ...
    "out/vec-compare-2/$kernel_base/trace-o3-$kernel_base.log" \
    "out/vec-compare-2/$kernel_base/trace-$kernel_base.log" >> $results_file
done
